...
def main():
    ...
    # ============================================================
    # ЭТАП 8.05: Запуск ежедневной проверки обновлений
    # ============================================================
    print("\n🔄 ЭТАП 8.05: Фоновая проверка обновлений")
    print("-" * 40)
    try:
        from files.core.oss.default.update_checker import UpdateCheckerModule
        UpdateCheckerModule.start_background_checker()
        print("   ✅ Фоновая проверка обновлений запущена (раз в сутки)")
    except Exception as e:
        print(f"   ⚠️ Ошибка запуска проверки обновлений: {e}")
