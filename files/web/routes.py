...
from files.core.utils.i18n_utils import get_available_languages, t, set_language, get_current_language, return_basic
...
def handle_sections():
    ...
    try:
        section = import_module(f'files.web.sections.{section_name}')
