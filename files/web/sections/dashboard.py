# files/web/sections/dashboard.py
import os
import platform
import socket
import sys
...
COMPONENT_CONFIG = {
    ...
    'tailscale': {
        'module': 'tailscale',
        'check': 'check_tailscale_installed',
...
def index(data, session):
    ...
    sys_info = {
        ...
        'os_type': get_global('os_type', platform.system().lower()),
        ...
        'tailscale': {
            ...
            'tailscale_ip': get_global('tailscale_ip', None),
        },
    }
