    ...
    "sections":{
        ...
        'dashboard': {
            ...
            'index': {
                ...
                'auto_install_title': 'Automatic Component Installation',
                'auto_install_description': 'Select components to install. Already installed ones are marked green and unavailable.',
                'start_install': 'Start Installation',
                'not_available_windows': 'Not available',
                'knocking_windows_stub': 'Port Knocking is not supported on Windows. Use Linux.'
            }
        },
        ...
        'knocking':{
            ...
            "index": {
                ...
                "knock_test": "Knock Test",
                "send_knock": "Send Knock",
                "manual_port_control": "Manual Port Control",
                "open": "Open",
                "close": "Close",
                "close_all": "Close All",
                "open_knock_ports": "Open Knock Ports",
        ...
        'vpn': {
            'basic': {
                'title': 'VPN Tailscale',
                'description': 'VPN connection management via Tailscale'
            },
            ...
            "index": {
                ...
                "tailscale_install_instructions": "VPN usage requires Tailscale installation",
                ...
                "tailscale_backend_state": "Backend state",
                "tailscale_headscale_server": "Headscale server",
                "tailscale_actions": "Actions",
                "tailscale_connect": "Connect to VPN",
                "tailscale_disconnect": "Disconnect",
                "tailscale_auth_required": "Authentication required",
                "tailscale_auth_click_link": "Click the link below to authenticate in browser",
                "tailscale_auth_open": "Open authentication page",
                "tailscale_auth_waiting": "Waiting for authentication...",
                "tailscale_info_title": "Tailscale VPN Information",
                "tailscale_technical_info": "Technical information",
                "tailscale_about": "About Tailscale",
                "tailscale_description": "Tailscale — mesh VPN based on WireGuard. Connects devices via encrypted tunnels without firewall configuration.",
                "tailscale_docs": "Tailscale Documentation",
                "tailscale_os": "Operating system",
                "tailscale_peers": "Devices in VPN network",
                "tailscale_online": "Online",
                "tailscale_offline": "Offline"
            }
        },
        ...
        'service': {
            ...
            'index': {
                ...
                "task_name_help": "Unique task name (latin, no spaces)",
                ...
                "task_description_placeholder": "Brief task description",
                ...
                "builtin": "Built-in",
                "module_updates": "Updates (updates)",
                "module_service": "Service (service)",
                "module_docker": "Docker",
                "module_ports": "Ports (portmanager)",
                "module_network": "Network (network)",
                "module_servers": "Servers (servers)",
                "task_params_json": "Parameters (JSON)",
                "task_events": "Events",
                "event_on_schedule": "On schedule",
                "event_on_startup": "On startup",
                "event_on_update": "On update",
                "event_on_demand": "On demand",
                "run_now": "Run now",
                "view_log": "View log",
                ...
                "task_name_required": "Enter task name"
            }
        },
        ...
        'git': {
            'basic': {
                'title': 'Git',
                'description': 'Git and repository management'
            },
            'index': {
                ...
                'installed': 'Installed',
                'not_installed': 'Not installed',
                'git_auth_status': 'Authentication',
                'not_configured': 'Not configured',
                'actions': 'Actions',
                'install_git': 'Install Git',
                'confirm_install_git': 'Install Git on your system?',
                'git_ready': 'Git is ready',
                'refresh': 'Refresh'
            }
        }
    }
