translations = {
    ...
    "main":{
        ...
        # ==================== 页脚 ====================
        "footer":{
            "copyright": "© 2026 MyIDon.SITE. 保留所有权利。"
        },
    ...
    "sections":{
        ...
        'dashboard': {
            ...
            'index': {
                ...
                'use_domain': '使用域名',
                'domain_name': '域名',
                'domain_name_placeholder': '输入您的域名（例如 example.com）',
                'domain_saved': '域名已保存',
                'domain_error': '保存域名时出错',
                'domain_access_setup': '域名访问设置',
                'domain_access_success': '域名访问配置成功',
                'domain_access_error': '配置域名访问时出错',
                "cpu": "处理器",
                "processor": "型号",
                "cores": "核心",
                "logical": "线程",
                ...
                'auto_install': '自动安装',
                'auto_install_title': '自动安装组件',
                'auto_install_description': '选择要安装的组件。已安装的标记为绿色且不可用。',
                'start_install': '开始安装',
                'not_available_windows': '不可用',
                'knocking_windows_stub': 'Windows 不支持端口敲击。请使用 Linux。'
            }
        },
        ...
        'knocking':{
            ...
            "index": {
                ...
                "windows_mode": "Windows 防火墙规则",
                "linux_mode": "knockd (Linux)",
                "target_port": "目标端口",
                "auto_close": "自动关闭",
                "knock_test": "Knock 测试",
                "send_knock": "发送 Knock",
                "manual_port_control": "手动端口控制",
                "open": "打开",
                "close": "关闭",
                "close_all": "全部关闭",
                "open_knock_ports": "已打开的端口",
        ...
        'vpn': {
            'basic': {
                'title': 'VPN Tailscale',
                'description': '通过 Tailscale 管理 VPN 连接'
            },
            ...
            "index": {
                ...
                "tailscale_install_instructions": "VPN 使用需要安装 Tailscale",
                "tailscale_install": "安装 Tailscale",
                "tailscale_status": "状态",
                "tailscale_connected": "已连接",
                "tailscale_disconnected": "已断开",
                "tailscale_ip": "Tailscale IP",
                "tailscale_hostname": "主机名",
                "tailscale_version": "版本",
                "tailscale_backend_state": "后端状态",
                "tailscale_headscale_server": "Headscale 服务器",
                "tailscale_actions": "操作",
                "tailscale_connect": "连接到 VPN",
                "tailscale_disconnect": "断开连接",
                "tailscale_auth_required": "需要授权",
                "tailscale_auth_click_link": "点击下方链接在浏览器中进行授权",
                "tailscale_auth_open": "打开授权页面",
                "tailscale_auth_waiting": "等待授权...",
                "tailscale_info_title": "Tailscale VPN 信息",
                "tailscale_technical_info": "技术信息",
                "tailscale_about": "关于 Tailscale",
                "tailscale_description": "Tailscale — 基于 WireGuard 的 mesh VPN。通过加密隧道连接设备，无需配置防火墙。",
                "tailscale_docs": "Tailscale 文档",
                "tailscale_os": "操作系统",
                "tailscale_peers": "VPN 网络中的设备",
                "tailscale_online": "在线",
                "tailscale_offline": "离线"
            }
        },
        ...
        'service': {
            ...
            'index': {
                ...
                "task_name_help": "任务唯一名称（拉丁字母，无空格）",
                "task_category": "类别",
                "category_system": "系统",
                ...
                "category_custom": "自定义",
                "task_description": "描述",
                "task_description_placeholder": "任务简要描述",
                "every_5min": "每5分钟",
                "every_30min": "每30分钟",
                "every_6h": "每6小时",
                "task_module": "模块",
                "task_function": "函数",
                "builtin": "内置",
                "module_updates": "更新 (updates)",
                "module_service": "服务 (service)",
                "module_docker": "Docker",
                "module_ports": "端口 (portmanager)",
                "module_network": "网络 (network)",
                "module_servers": "服务器 (servers)",
                "task_params_json": "参数 (JSON)",
                "task_events": "事件",
                "event_on_schedule": "按计划",
                "event_on_startup": "启动时",
                "event_on_update": "更新时",
                "event_on_demand": "按需",
                "run_now": "立即运行",
                "view_log": "查看日志",
        ...
        'git': {
            ...
            'index': {
                ...
                'installed': '已安装',
                'not_installed': '未安装',
                'git_auth_status': '身份验证',
                'not_configured': '未配置',
                'actions': '操作',
                'install_git': '安装 Git',
                'confirm_install_git': '在系统上安装 Git？',
                'git_ready': 'Git 已就绪',
                'refresh': '刷新'
            }
        }
