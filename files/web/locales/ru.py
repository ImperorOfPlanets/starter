translations = {
    ...
    "main":{
        ...
        # ==================== Подвал ====================
        "footer":{
            "copyright": "© 2026 MyIDon.SITE. Все права защищены."
        },
    ...
    "sections":{
        ...
        'dashboard': {
            ...
            'index': {
                ...
                'domain_setup': 'Настройка домена',
                'use_domain': 'Использовать доменное имя',
                'domain_name': 'Доменное имя',
                'domain_name_placeholder': 'Введите ваше доменное имя (например, example.com)',
                'domain_saved': 'Доменное имя сохранено',
                'domain_error': 'Ошибка при сохранении доменного имени',
                'domain_access_setup': 'Настройка доступа к домену',
                'domain_access_success': 'Доступ к домену успешно настроен',
                'domain_access_error': 'Ошибка при настройке доступа к домену',
                "cpu": "Процессор",
                "processor": "Модель",
                "cores": "Ядра",
                "logical": "потоков",
                ...
                'auto_install': 'Автоустановка',
                'auto_install_title': 'Автоматическая установка компонентов',
                'auto_install_description': 'Выберите компоненты для установки. Уже установленные отмечены зелёным и недоступны для повторной установки.',
                'start_install': 'Начать установку',
                'not_available_windows': 'Недоступно',
                'knocking_windows_stub': 'Port Knocking не поддерживается на Windows. Используйте Linux.'
            }
        },
        ...
        'knocking':{
            ...
            "index": {
                ...
                "service_update_failed": "Не удалось обновить сервис",
                "install":"Установить",
                ...
                "windows_mode": "Windows Firewall Rules",
                "linux_mode": "knockd (Linux)",
                "target_port": "Целевой порт",
                "auto_close": "Авто-закрытие",
                "knock_test": "Тест Knock",
                "send_knock": "Отправить Knock",
                "manual_port_control": "Ручное управление портами",
                "open": "Открыть",
                "close": "Закрыть",
                "close_all": "Закрыть все",
                "open_knock_ports": "Открытые порты",
        ...
        'vpn': {
            'basic': {
                'title': 'VPN Tailscale',
                'description': 'Управление VPN-подключением через Tailscale'
            },
            ...
            "index": {
                ...
                "yes": "Да",
                "no": "Нет",
                "tailscale_not_installed": "Tailscale не установлен",
                "tailscale_install_instructions": "Для использования VPN необходимо установить Tailscale",
                "tailscale_install": "Установить Tailscale",
                "tailscale_status": "Статус",
                "tailscale_connected": "Подключен",
                "tailscale_disconnected": "Отключен",
                "tailscale_ip": "Tailscale IP",
                "tailscale_hostname": "Имя хоста",
                "tailscale_version": "Версия",
                "tailscale_backend_state": "Состояние",
                "tailscale_headscale_server": "Headscale сервер",
                "tailscale_actions": "Действия",
                "tailscale_connect": "Подключить к VPN",
                "tailscale_disconnect": "Отключить",
                "tailscale_auth_required": "Требуется авторизация",
                "tailscale_auth_click_link": "Нажмите на ссылку ниже для авторизации в браузере",
                "tailscale_auth_open": "Открыть страницу авторизации",
                "tailscale_auth_waiting": "Ожидание авторизации...",
                "tailscale_info_title": "Информация о Tailscale VPN",
                "tailscale_technical_info": "Техническая информация",
                "tailscale_about": "О Tailscale",
                "tailscale_description": "Tailscale — mesh VPN на базе WireGuard. Подключает устройства через зашифрованные туннели без настройки файрвола.",
                "tailscale_docs": "Документация Tailscale",
                "tailscale_os": "Операционная система",
                "tailscale_peers": "Устройства в VPN-сети",
                "tailscale_online": "Онлайн",
                "tailscale_offline": "Оффлайн"
            }
        },
        ...
        'service': {
            ...
            'index': {
                ...
                "task_name_help": "Уникальное имя задачи (латиница, без пробелов)",
                "task_category": "Категория",
                "category_system": "Система",
                "category_monitoring": "Мониторинг",
                "category_maintenance": "Обслуживание",
                "category_custom": "Пользовательские",
                "task_description": "Описание",
                "task_description_placeholder": "Краткое описание задачи",
                "every_5min": "Каждые 5 минут",
                "every_30min": "Каждые 30 минут",
                "every_6h": "Каждые 6 часов",
                "task_module": "Модуль",
                "task_function": "Функция",
                "builtin": "Встроенная",
                "module_updates": "Обновления (updates)",
                "module_service": "Сервис (service)",
                "module_docker": "Docker",
                "module_ports": "Порты (portmanager)",
                "module_network": "Сеть (network)",
                "module_servers": "Серверы (servers)",
                "task_params_json": "Параметры (JSON)",
                "task_events": "События",
                "event_on_schedule": "По расписанию",
                "event_on_startup": "При запуске",
                "event_on_update": "При обновлении",
                "event_on_demand": "По требованию",
                ...
                "task_name_required": "Введите имя задачи"
            }
        },
        ...
        'git': {
            'basic': {
                'title': 'Git',
                'description': 'Управление Git и репозиториями'
            },
            'index': {
                'git_info': 'Информация о Git',
                'status': 'Статус',
                'installed': 'Установлен',
                'not_installed': 'Не установлен',
                'git_auth_status': 'Аутентификация',
                'not_configured': 'Не настроена',
                'actions': 'Действия',
                'install_git': 'Установить Git',
                'confirm_install_git': 'Установить Git на вашу систему?',
                'git_ready': 'Git готов к работе',
                'refresh': 'Обновить'
            }
        }
    }
